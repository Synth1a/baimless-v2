...
bool __fastcall Hooks::IsConnected(void* ecx, void* edx)
{
	...
	static void* is_loadout_allowed = (void*)(Utils::Scan("client.dll", "84 C0 75 04 B0 01 5F"));
...
void SetClanTag(const char* tag, const char* name)
{
	...
	if (!dw_ClanTag)
		dw_ClanTag = reinterpret_cast<ClanTagFn>(((DWORD)Utils::FindPattern("engine.dll", (PBYTE)"\x53\x56\x57\x8B\xDA\x8B\xF9\xFF\x15", "xxxxxxxxx")));
...
bool __fastcall Hooks::CreateMove(IClientMode* thisptr, void* edx, float sample_frametime, CUserCmd* pCmd)
{
	...
	byte* SendPacket = (byte*)(*FPointer - 0x34);
...
private:
	...
	CUtlVectorSimple *ClientSideAnimationList = (CUtlVectorSimple*)*(DWORD*)(Utils::FindSignature("client.dll", "A1 ? ? ? ? F6 44 F0 04 01 74 0B") + 1);
};
