...
bool C_BaseEntity::IsWeapon()
{
    ...
    return qCallVFunction<bool(__thiscall*)(C_BaseEntity*)>(this, 166 + VALVE_ADDED_FUNCS)(this);
}
...
{
	return qCallVFunction<bool(__thiscall*)(C_BaseEntity*)>(this, 158 + VALVE_ADDED_FUNCS)(this);
}
...
void C_BaseEntity::set_abs_origin(const Vector & origin)
{
	...
	static auto fn = reinterpret_cast<Fn>((Utils::FindSignature("client.dll", "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8 1F")));
...
void C_BaseEntity::setAbsAngle(Vector Angle) 
{
	...
	if (!SetAbsAngle)
		SetAbsAngle = (SetAbsAngleFn)(Utils::FindSignature("client.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8"));
...
void C_BaseEntity::SetAbsAngles(Vector wantedang)
{
	...
	static oSetAngle _SetAngle = (oSetAngle)((uintptr_t)Utils::FindSignature("client.dll", "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8"));
	_SetAngle(this, wantedang);
}
void C_BaseEntity::SetAbsOrigin(const Vector &origin)
{
	using SetAbsOriginFn = void(__thiscall*)(void*, const Vector &origin);
	static SetAbsOriginFn SetAbsOrigin = (SetAbsOriginFn)Utils::FindSignature("client.dll", "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8 1F");
...
void C_BaseEntity::SetAbsVelocity(Vector velocity) // i dont remember
{
	...
	static Fn AbsVelocity = (Fn)Utils::FindSignature("client.dll", "55 8B EC 83 E4 F8 83 EC 0C 53 56 57 8B 7D 08 8B F1");
...
void C_BaseEntity::SetAbsOriginal(Vector origin)
{
	...
	if (!SetAbsOrigin)
		SetAbsOrigin = (SetAbsOriginFn)((DWORD)Utils::FindPattern("client.dll", (BYTE*)"\x55\x8B\xEC\x83\xE4\xF8\x51\x53\x56\x57\x8B\xF1\xE8\x00\x00", "xxxxxxxxxxxxx??"));
	SetAbsOrigin(this, origin);
}
