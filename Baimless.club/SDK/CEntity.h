...
//	OFFSET(get_model_ptr, CStudioHdr*, 0x294C)
	...
	{
		return *reinterpret_cast<C_AnimState**>(uintptr_t(this) + 0x9960);
	}
	...
	void UpdateClientAnimation()
	{
		...
		Utils::GetVFunc<original>(this, 224)(this);
	}
	...
	{
		static int m_hActiveWeapon = NetvarManager::Instance()->GetOffset("DT_BaseCombatCharacter", "m_hActiveWeapon");
		return *reinterpret_cast<int*>(uintptr_t(this) + m_hActiveWeapon) & 0x2F08; //m_hActiveWeapon
	}
    int GetTeam()
    {
	...
	{
		return *reinterpret_cast<Vector*>(uintptr_t(this) + uintptr_t(0x303C));
	}

	Vector GetViewPunchAngle()
	{
		return *reinterpret_cast<Vector*>(uintptr_t(this) + uintptr_t(0x3030));
	}
...
public:
	...
	float GetInaccuracy()
	{
		...
		return Utils::GetVFunc< oInaccuracy >(this, 483)(this);
	}
	...
	float GetSpread()
	{
		...
		return Utils::GetVFunc< oWeaponSpread >(this, 453)(this);
	}
	...
	void AccuracyPenalty()
	{
		...
		return Utils::GetVFunc<OrigFn>(this, 484)(this);
	}
